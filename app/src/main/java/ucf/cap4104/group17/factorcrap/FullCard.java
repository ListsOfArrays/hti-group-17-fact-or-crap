...
public class FullCard implements CardDescription {
    public static ArrayList<FullCard> getCards() {
        ...
        fullCardList.add(new FullCard("New Zealand will deny people residency visa’s if they have too high of a BMI and there are cases where people have been rejected because of their weight.", true));
        fullCardList.add(new FullCard("Whenever a pregnant woman suffers from organ damage like heart attack, the fetus sends stem cells to the organ helping it to repair.", true));
        fullCardList.add(new FullCard("It is illegal to climb trees in Oshawa, a town in Ontario, Canada.", true));
        fullCardList.add(new FullCard("Brown eyes are blue underneath, and you can get surgery to turn brown eyes blue.", true));
        ...
        fullCardList.add(new FullCard("When a person cries and the first drop of tears come from the right eye, it's happiness. If it's from left eye, it’s pain.", true));
        ...
        fullCardList.add(new FullCard("When howling together, no two wolves will howl on the same note, instead, they harmonize to create the illusion that there are more of them than there are.", true));
        ...
        fullCardList.add(new FullCard("A day on Venus lasts longer than a year; 243 Earth days.", true));
        ...
        fullCardList.add(new FullCard("Melting ice and icebergs make frizzing noise called “bergy seltzer”.", true));
        ...
        fullCardList.add(new FullCard("A study found that having friends from other cultures makes you more creative.", true));
        ...
        fullCardList.add(new FullCard("Smiling boosts your immune system.", true));
        ...
        fullCardList.add(new FullCard("At rest, your brain burns one fifth of a calorie per minute.", true));
        fullCardList.add(new FullCard("A single tree can absorb more than 10 pounds of CO2 each year.", true));
        fullCardList.add(new FullCard("The Amazon River once flowed in the opposite direction, from east to west.", true));
        ...
        fullCardList.add(new FullCard("Elevators have killed or can kill when their cable snaps.", false));
        ...
        fullCardList.add(new FullCard("If someone wrongly advertises goods for the wrong price, they must sell it to you at that price.", false));
        ...
        fullCardList.add(new FullCard("The Great Wall of China is the only man-made structure visible from space.", false));
